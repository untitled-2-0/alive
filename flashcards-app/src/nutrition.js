...
export const NUTRIENTS = [
  { k: "kcal",       label: "Калорії",     unit: "ккал", cat: "energy", kind: "goal" },
  { k: "protein",    label: "Білки",       unit: "г",    cat: "macro",  kind: "goal" },
  { k: "fat",        label: "Жири",        unit: "г",    cat: "macro",  kind: "goal" },
  { k: "satFat",     label: "з них насичені", unit: "г", cat: "macro",  kind: "ceiling", sub: true },
  { k: "carbs",      label: "Вуглеводи",   unit: "г",    cat: "macro",  kind: "goal" },
  { k: "sugar",      label: "з них цукри", unit: "г",    cat: "macro",  kind: "ceiling", sub: true },
  { k: "fiber",      label: "Клітковина",  unit: "г",    cat: "macro",  kind: "goal" },

  { k: "iron",       label: "Залізо",      unit: "мг",   cat: "min", kind: "goal" },
  { k: "zinc",       label: "Цинк",        unit: "мг",   cat: "min", kind: "goal" },
  { k: "copper",     label: "Мідь",        unit: "мг",   cat: "min", kind: "goal" },
  { k: "magnesium",  label: "Магній",      unit: "мг",   cat: "min", kind: "goal" },
  { k: "calcium",    label: "Кальцій",     unit: "мг",   cat: "min", kind: "goal" },
  { k: "potassium",  label: "Калій",       unit: "мг",   cat: "min", kind: "goal" },
  { k: "phosphorus", label: "Фосфор",      unit: "мг",   cat: "min", kind: "goal" },
  { k: "selenium",   label: "Селен",       unit: "мкг",  cat: "min", kind: "goal" },
  { k: "iodine",     label: "Йод",         unit: "мкг",  cat: "min", kind: "goal" },
  { k: "sodium",     label: "Натрій (сіль)", unit: "мг", cat: "min", kind: "ceiling" },

  { k: "vitA",       label: "Вітамін A",   unit: "мкг",  cat: "vit", kind: "goal" },
  { k: "vitC",       label: "Вітамін C",   unit: "мг",   cat: "vit", kind: "goal" },
  { k: "vitD",       label: "Вітамін D",   unit: "мкг",  cat: "vit", kind: "goal" },
  { k: "vitE",       label: "Вітамін E",   unit: "мг",   cat: "vit", kind: "goal" },
  { k: "vitK",       label: "Вітамін K",   unit: "мкг",  cat: "vit", kind: "goal" },
  { k: "b1",         label: "B1 тіамін",   unit: "мг",   cat: "vit", kind: "goal" },
  { k: "b2",         label: "B2 рибофлавін", unit: "мг", cat: "vit", kind: "goal" },
  { k: "b3",         label: "B3 ніацин",   unit: "мг",   cat: "vit", kind: "goal" },
  { k: "b6",         label: "B6",          unit: "мг",   cat: "vit", kind: "goal" },
  { k: "b9",         label: "B9 фолат",    unit: "мкг",  cat: "vit", kind: "goal" },
  { k: "b12",        label: "B12",         unit: "мкг",  cat: "vit", kind: "goal" },
];
