...
export const NUTRIENTS = [
  ...
  { k: "creatine",  label: "Креатин",  unit: "мг", cat: "other", kind: "info", info: "Паливо для коротких потужних зусиль: перші секунди підходу, ривок, підйом сходами. Тіло виробляє близько грама на день саме, ще стільки ж дає мʼясо й риба — у рослинній їжі креатину нема взагалі, тому на вегетаріанстві його запаси нижчі.\n\nОкремо про добавки: у дослідженнях це найкраще вивчена спортивна добавка — 3–5 г моногідрату на день підвищують силу й витривалість у коротких зусиллях, і є дані про користь для памʼяті та настрою, особливо при недосипі. Переноситься добре; перші дні буває затримка води (1–2 кг на вагах — це вода в мʼязах, не жир). При хворобах нирок — тільки з лікарем." },
...
{"name":"назва українською","group":"категорія українською","kcal":0,"protein":0,"fat":0,"satFat":0,"carbs":0,"sugar":0,"fiber":0,"iron":0,"zinc":0,"copper":0,"magnesium":0,"calcium":0,"potassium":0,"sodium":0,"phosphorus":0,"selenium":0,"iodine":0,"vitA":0,"vitC":0,"vitD":0,"vitE":0,"vitK":0,"b1":0,"b2":0,"b3":0,"b5":0,"b6":0,"b7":0,"b9":0,"b12":0,"omega3ala":0,"omega3epadha":0,"taurine":0,"inositol":0,"creatine":0}

Одиниці: kcal — ккал; protein, fat, satFat, carbs, sugar, fiber — грами; iron, zinc, copper, magnesium, calcium, potassium, sodium, phosphorus, vitC, vitE, b1, b2, b3, b5, b6, taurine, inositol, creatine, omega3epadha — мг; selenium, iodine, vitA, vitD, vitK, b7, b9, b12 — мкг; omega3ala — грами. Усе на 100 г. Кожне поле обов'язкове, став 0 там, де справді нуль.`;
